...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        this.theme = theme ?? CustomDatePickerTheme(),
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    CustomDatePickerTheme theme = widget.route.theme;
  ...
  Widget _renderPickerView(CustomDatePickerTheme theme) {
  ...
  Widget _renderItemView(CustomDatePickerTheme theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(CustomDatePickerTheme theme) {
